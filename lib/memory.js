    ...
    return (function () {
        ...
        return {
            measureMemory: function(isLast){
                return module.exports.measureMemory(memoryResult, isLast, filename, csvFilename, options, graphData).then(function (result) {
                    memoryResult = result;
 ...
 */
module.exports.measureMemory = function (previousResult, isLast, filename, csvFilename, options, graphData) {
    options = options || {};
