    ...
    return (function () {
        ...
        return {
            measureMemory: function(isLast){
                return module.exports.measureMemory(isLast ? initialResult : memoryResult, isLast, filename, csvFilename, options).then(function (result) {
 ...
 */
module.exports.measureMemory = function (comparisonMeasurement, isLast, filename, csvFilename, options) {
    options = options || {};
