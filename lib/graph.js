...
module.exports.generateGraphImage = function(filename, graphData, graphWidth, graphHeight) {
	...
	protractor.promise.controlFlow().execute(function() {
        return module.exports.phantomRender(filename, graphData, graphWidth, graphHeight);
    }).then(function() {d.fulfill(true);});
        ...
        return ph.createPage(function(page) {
            ...
            page.injectJs(path.join(__dirname, '../node_modules/d3/d3.js'), function(fileFound) {
                if(fileFound) {
                    ...
                    page.evaluate(d3graph, function(){}, graphData, graphWidth, graphHeight);	
